...
GEN_ABSOLUTE_SYM(CONFIG_GPIO_NRF5_GPIOTE_CHAN_BASE, 0);
...
GEN_ABSOLUTE_SYM(CONFIG_DHT_CHIP_DHT11, 1);
GEN_ABSOLUTE_SYM(CONFIG_MP_NUM_CPUS, 1);
GEN_ABSOLUTE_SYM(CONFIG_DHT_NAME, 1);
GEN_ABSOLUTE_SYM(CONFIG_DHT_GPIO_DEV_NAME, 1);
GEN_ABSOLUTE_SYM(CONFIG_DHT_GPIO_PIN_NUM, 19);
