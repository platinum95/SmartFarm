...
#define K_SYSCALL_DECLARE0_VOID(id, name) \
	...
	{ \
		...
		return (void)_arch_syscall_invoke0(id); \
	}
...
#define K_SYSCALL_DECLARE1_VOID(id, name, t0, p0) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_arch_syscall_invoke1((u32_t)p0, id); \
	}
...
#define K_SYSCALL_DECLARE2_VOID(id, name, t0, p0, t1, p1) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_arch_syscall_invoke2((u32_t)p0, (u32_t)p1, id); \
	}
...
#define K_SYSCALL_DECLARE3_VOID(id, name, t0, p0, t1, p1, t2, p2) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_arch_syscall_invoke3((u32_t)p0, (u32_t)p1, (u32_t)p2, id); \
	}
...
#define K_SYSCALL_DECLARE4_VOID(id, name, t0, p0, t1, p1, t2, p2, t3, p3) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_arch_syscall_invoke4((u32_t)p0, (u32_t)p1, (u32_t)p2, (u32_t)p3, id); \
	}
...
#define K_SYSCALL_DECLARE5_VOID(id, name, t0, p0, t1, p1, t2, p2, t3, p3, t4, p4) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_arch_syscall_invoke5((u32_t)p0, (u32_t)p1, (u32_t)p2, (u32_t)p3, (u32_t)p4, id); \
	}
...
#define K_SYSCALL_DECLARE6_VOID(id, name, t0, p0, t1, p1, t2, p2, t3, p3, t4, p4, t5, p5) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_arch_syscall_invoke6((u32_t)p0, (u32_t)p1, (u32_t)p2, (u32_t)p3, (u32_t)p4, (u32_t)p5, id); \
	}
...
#define K_SYSCALL_DECLARE7_VOID(id, name, t0, p0, t1, p1, t2, p2, t3, p3, t4, p4, t5, p5, t6, p6) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_syscall_invoke7((u32_t)p0, (u32_t)p1, (u32_t)p2, (u32_t)p3, (u32_t)p4, (u32_t)p5, (u32_t)p6, id); \
	}
...
#define K_SYSCALL_DECLARE8_VOID(id, name, t0, p0, t1, p1, t2, p2, t3, p3, t4, p4, t5, p5, t6, p6, t7, p7) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_syscall_invoke8((u32_t)p0, (u32_t)p1, (u32_t)p2, (u32_t)p3, (u32_t)p4, (u32_t)p5, (u32_t)p6, (u32_t)p7, id); \
	}
...
#define K_SYSCALL_DECLARE9_VOID(id, name, t0, p0, t1, p1, t2, p2, t3, p3, t4, p4, t5, p5, t6, p6, t7, p7, t8, p8) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_syscall_invoke9((u32_t)p0, (u32_t)p1, (u32_t)p2, (u32_t)p3, (u32_t)p4, (u32_t)p5, (u32_t)p6, (u32_t)p7, (u32_t)p8, id); \
	}
...
#define K_SYSCALL_DECLARE10_VOID(id, name, t0, p0, t1, p1, t2, p2, t3, p3, t4, p4, t5, p5, t6, p6, t7, p7, t8, p8, t9, p9) \
	...
	{ \
		static _GENERIC_SECTION(hndlr_ref) __used void *href = (void *)&hdlr_##name; \
		return (void)_syscall_invoke10((u32_t)p0, (u32_t)p1, (u32_t)p2, (u32_t)p3, (u32_t)p4, (u32_t)p5, (u32_t)p6, (u32_t)p7, (u32_t)p8, (u32_t)p9, id); \
	}
